...
while True:
    ...
    # Players
    pygame.draw.rect(screen, "white", pygame.Rect(p1_paddle_width + 5, p1_position, p1_paddle_width, p1_paddle_height), 0, 0, 0, 10, 0, 10)
    pygame.draw.rect(screen, "white", pygame.Rect(width - p2_paddle_width * 2 - 5, p2_position, p1_paddle_width, p2_paddle_height), 0, 0, 10, 0, 10, 0)
